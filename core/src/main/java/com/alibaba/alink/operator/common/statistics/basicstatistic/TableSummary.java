...
public class TableSummary extends BaseSummary {
	 ...
	 * sum2_i = sum(x_i * x_i)
	 */
	public DenseVector sum2;

	/**
	 * sum3_i = sum(x_i * x_i * x_i)
	 */
	public DenseVector sum3;

	/**
	 * sum4_i = sum(x_i * x_i * x_i * x_i)
	 */
	public DenseVector sum4;

	/**
	 * min_i = min(x_i)
	 */
	public DenseVector minDouble;

	/**
	 * max_i = max(x_i)
	 */
	public DenseVector maxDouble;
	 ...
	 */
	public int[] numericalColIndices;
